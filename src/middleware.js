...
const adminPages = ["/screens/addProduct"];
...
export default function middleware(req) {
  ...
  if (authToken && isPublicPage) {
    return NextResponse.redirect(new URL("/screens/products", req.url));
  }

  // If authenticated but not admin and trying to access admin page, redirect
  if (authToken && isAdminPage && userRole !== "admin") {
    return NextResponse.redirect(new URL("/screens/products", req.url));
  }
